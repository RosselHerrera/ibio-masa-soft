...
<%
/* ------------------------------------------------ */
String Documento = request.getParameter("condicion");
/* ------------------------------------------------ */
...
String  FILLER = "";
	...
	/* --------------------------------------------------- */
		ArrayList ListaMovimientos = movimiento.ListaMovimientos(Documento);
									...
									<div class="progress-table-wrap">
										<div class="progress-table">
											...
											<% while (it.hasNext()){
												...
												<div class="serial"><%=ivaloragregado%></div>
